...
void menuAdmin() {
    ...
    cout << PUTIH  <<    "| 6. | Keluar ke Menu Login                             |" << endl;
...
void menuUser() {
    ...
    cout << PUTIH  <<    "| 2. | Sorting Data                                     |" << endl;
    cout << PUTIH  <<    "| 3. | Keluar ke Menu Login                             |" << endl;
    cout << ABU_REDUP << "=========================================================" << RESET << endl;
}
        ...
        if (ptrCurrentUser->isAdmin) { 
           ...
           switch (menu) {
            ...
            switch (menu) {
                ...
                case 2: menuSorting(logistik, jumlahLogistik); break;
                case 3: return;
            }
        }
    }
